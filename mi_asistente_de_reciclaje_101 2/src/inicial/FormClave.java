 ...
 */
public class FormClave extends javax.swing.JFrame {

    /**
     * Creates new form FormClave
     */
    public FormClave() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btn_validar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 170, -1));
        ...
        jLabel2.setText("Ingrese su homoclave para crear una cuenta");
        ...
        jLabel5.setText("Si no cuanta con una homoclave valida regrese al menu y seleccione otro perfil.");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, 20));
        ...
        jPanel2.add(txt_contrasenia, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 490, -1));

        jLabel3.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(45, 45, 41));
        jLabel3.setText("Homoclave");
    ...
    private void btn_validarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validarActionPerformed
        CClave objetoClave = new CClave();
        objetoClave.validarClave(txt_contrasenia);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormClave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
